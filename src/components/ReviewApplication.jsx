...
export const ReviewApplication= ()=> {
    ...
    return (
        <form className="justify-end items-end rounded bg-white flex flex-col px-6 max-md:px-5 max-w-[528px]">
            ...
            <input type="submit" value="Submit your application" className="text-white text-base font-semibold leading-6 tracking-normal whitespace-nowrap flex justify-center items-stretch bg-blue-500 w-[219px] max-w-full my-6 px-4 py-2 rounded-xl self-end cursor-pointer"/>
