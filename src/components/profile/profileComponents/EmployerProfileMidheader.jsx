            ...
            <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                ...
                <div className="flex flex-col items-stretch w-[43%] ml-5 max-md:w-full max-md:ml-0">
                    <div className="items-stretch flex grow justify-between gap-4 max-md:mt-10">
                        {/*<img*/}
                        {/*    loading="lazy"*/}
                        {/*    src="https://cdn.builder.io/api/v1/image/assets/TEMP/6917611a-58e2-40fb-8f7c-7959c8db0a2d?apiKey=2a664b353843410292501e6f128833a4&width=200"*/}
                        ...
                        <div className="items-stretch flex gap-4 mt-16 self-end max-md:mt-10">
                            <div
                                className="text-blue-500 text-base font-medium leading-6 tracking-normal whitespace-nowrap justify-center items-stretch border border-[color:var(--Blue-1,#2F80ED)] grow px-4 py-2 rounded-xl border-solid">
                                Change Avatar
                            </div>
                            <div
                                className="text-rose-500 text-base font-medium leading-6 tracking-normal self-center whitespace-nowrap my-auto">
                                Delete
                            </div>
                        </div>
                    </div>
